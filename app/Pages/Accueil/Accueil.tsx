...
export default function Accueil() {
  return (
    <div className='relative w-full h-full text-white'>
     ...
     <div className='flex justify-center items-center  bg-fpblue p-2 right-0 top-72 fixed z-50 shadow-3xl shadow-white rounded-l-lg hover:bg-pblue cursor-pointer'>
