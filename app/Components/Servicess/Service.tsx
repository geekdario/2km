  ...
  return (
    <div id="services" className="w-full mt-20 relative z-10">
      <Image
        src={cercleeffe}
        alt="cercle effet"
        className="w-16 absolute -z-10 hidden md:flex md:left-96 md:top-0"
      />
      <h1 className="mt-2 text-xl md:text-3xl font-extrabold leading-relaxed text-center pb-8">
        JE PROPOSE DES{" "}
        <span className="bg-pblue px-2 mr-2 font-extrabold shadow-lg rounded-tl-2xl rounded-br-2xl ">
          SERVICES
        </span>
        <br /> DE QUALITES
      </h1>
      ...
      <div className="flex justify-center flex-wrap items-center w-full">
        <div
          className={`grid grid-cols-1 gap-4 lg:grid-cols-4 md:gap-4 md:grid-cols-3 sm:grid-cols-2`}
        >
          <div className="flex flex-col items-center justify-center border-dashed border-2 shadow-2xl border-pblue w-60 pt-4 rounded-xl transition-all cursor-pointer hover:bg-pblue hover:transition-all hover:-translate-y-2 md:hover:-translate-y-4">
            ...
            <p className="text-center p-5 font-sans">
              Réalisation complete de maquette pour votre site
              vitrine,application web et mobile{" "}
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center border-dashed border-2 shadow-2xl border-pblue w-60 pt-4 rounded-xl transition-all cursor-pointer hover:bg-pblue hover:transition-all hover:-translate-y-2 md:hover:-translate-y-4">
            ...
            <p className="text-center p-5 font-sans">
              Conversion d'une maquette en site vitrine,application web et
              mobile{" "}
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center border-dashed border-2 shadow-2xl border-pblue w-60 pt-4 rounded-xl transition-all cursor-pointer hover:bg-pblue hover:transition-all hover:-translate-y-2 md:hover:-translate-y-4">
            ...
            <p className="text-center p-5 font-sans">
              Développement sur mesure de votre site vitrine,application web et
              mobile{" "}
            </p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center border-dashed border-2 shadow-2xl border-pblue w-60 pt-4 rounded-xl transition-all cursor-pointer hover:bg-pblue hover:transition-all hover:-translate-y-2 md:hover:-translate-y-4">
            ...
            <p className="text-center p-5 font-sans">
              Identifiez-vous par votre logo,Flyer,Carte de visite etc...
            </p>
          </div>
        </div>
      </div>
