...
export const Hireme = () => {
  return (
    ...
    <div className='flex-wrap  md:flex flex-col md:items-start'>
        <h2 className='text-2xl text-center md:text-4xl md:leading-normal  font-semibold'>Aviez-vous besoin<br/>de mes <span className='bg-pblue px-2 mr-2 font-extrabold shadow-lg rounded-tl-2xl rounded-br-2xl mt-2'>Services</span>?</h2>
