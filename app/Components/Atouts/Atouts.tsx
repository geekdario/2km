...
export const Atouts = () => {
  ...
  return (
    <div className='flex-wrap md:flex justify-center  items-center w-full py-5'>
        <div className='' >
            <Image src={programmer} alt='le programmeur' className='md:ml-5 h-72 md:h-96 transition-all hover:opacity-70 hover:transition-all hover:delay-150 '/>
        </div>
        <div className='md:flex flex-col'>
            <h2 className='text-2xl md:text-4xl leading-normal text-center'>Découverte de certaines<br/><span className='bg-pblue px-2 mr-2 font-extrabold shadow-lg rounded-tl-2xl rounded-br-2xl mt-2'>Atouts</span>durant ma formation</h2>
