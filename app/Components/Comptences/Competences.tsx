...
export const Competences = () => {
  ...
  return (
    <div className='w-full pt-20'>
        ...
        <h1 id='Competences' className='mt-2 text-xl md:text-3xl font-extrabold leading-relaxed text-center pb-8'> <span className='bg-pblue px-2 mr-2 font-extrabold shadow-lg rounded-tl-2xl rounded-br-2xl'>
