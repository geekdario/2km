  ...
  return (
    <nav className={`w-full text-l flex  justify-between md:justify-around items-center p-3 transition-all delay-0 ${ posfixe ?"md:fixed md:bg-pblue md:top-0 md:z-50 md:transition-all md:delay-75 md:shadow-xl md:brightness-95":" "}`}>
      ...
      <ul className=' md:flex justify-center items-center font-extrabold uppercase md:lowercase'>
        ...
        <li className='mx-4  md:hover:border-b-4 md:hover: border-b-pblue transition-all delay-150 hover:rounded hover:text-fpblue hover:brightness-150'><a onClick={() => router.push('/projet')}>Projets</a></li>
