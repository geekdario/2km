...
export const Navbar = () => {
  ...
  return (
    <nav className='w-full text-l flex justify-between md:justify-around items-center p-3'>
      ...
      <div className={`bg-fpblue md:flex justify-center items-center ${isopen ? "block absolute w-72 right-2 top-11 rounded-lg shadow shadow-black text-center text-xl p-5 " :"hidden"}`}>
